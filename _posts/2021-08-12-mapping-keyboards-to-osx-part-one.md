...
I also remapped the otherwise-useless `≣` (`Application`) key to the `Fn` key. You can see that I haven't reassigned the F5 key; we'll return to this key in Part 3 of this series.
